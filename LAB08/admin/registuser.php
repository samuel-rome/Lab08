        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <a class="navbar-brand" href="../index.php">
              <img class="Logotipos" src="https://w7.pngwing.com/pngs/924/165/png-transparent-note-and-pencil-illustration-computer-icons-icon-design-symbol-registration-miscellaneous-angle-text-thumbnail.png" alt="" width="35" height="35">
          </a>
            <ul class="navbar-nav me-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link fw-bold text-light" href="registuser.php">Registro Usuario</a>
              </li>
              <li class="nav-item">
